...
class MySliceProvider : SliceProvider() {
    ...
    /**
     * Converts URL to content URI (i.e. content://zs.jetpack.slice...)
     */
        ...
        return context?.let {
            SliceAction.create(
                PendingIntent.getActivity(
                    context, 0, Intent(it, MainActivity::class.java), PendingIntent.FLAG_IMMUTABLE
                ),
                IconCompat.createWithResource(it, R.drawable.ic_launcher_foreground),
